...
extern void          GetMonoSampleData(Sample* sample, double cursor_pos, float* dataLR);
extern void          GeStereoSampleData(Sample* sample, double cursor_pos, float* dataL, float* dataR);
